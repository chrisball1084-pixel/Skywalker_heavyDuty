...
ok("Version im Cache-Namen", sw.includes("sky-training-v6.11.0"));
// SW-Syntax prüfen
const vm=require('vm');
...
ok("Version v6.11.0", w.APP_VERSION==="v6.11.0");
...
// Unvollstaendiges Training fragt seit v6.11.0 nach — Rueckfrage bestaetigen

...
ok("Version im Cache-Namen", sw.includes("sky-training-v6.9.4"));
// SW-Syntax prüfen
const vm=require('vm');
...
ok("Version v6.9.4", w.APP_VERSION==="v6.9.4");
...
// Unvollstaendiges Training fragt seit v6.9.4 nach — Rueckfrage bestaetigen
